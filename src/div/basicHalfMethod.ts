/*
  ...
  Overwrites A
*/
export default function basicHalfMethod(integer: number[], len: number, base: number, isNegative: boolean): [number, number] {
  ...
  //Return new length
  return [(integer[len - 1] === 0) ? len - 1 : len, remainder];
};
