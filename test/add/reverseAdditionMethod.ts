...
function test(A: number[], B: number[], C: number[], base: number): void {
  ...
  const len: number = A.length = ReverseAdditionMethod(A, 0, A.length, B, 0, B.length, base);
...
describe('ReverseAdditionMethod', function(){
  ...
  it('should return 5+5 in base 10',
    () => test([5], [5], [0,1], 10)
  );
  ...
  it('should return 123+456789 in base 10',
    () => test([3,2,1], [9,8,7,6,5,4], [2,1,9,6,5,4], 10)
  );
  ...
  it('should return 1+9,999,999 in base 10',
    () => test(
      [1],
      [9,9,9,9,9,9,9],
      [0,0,0,0,0,0,0,1], 10
  ...
  it('should return 1+109,999,999 in base 10',
    () => test(
      [1],
      [9,9,9,9,9,9,9,0,1],
