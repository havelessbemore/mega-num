...
describe('decrement', function(){
  ...
  it('should return 10-1 in base 10',
    () => test([0,1], 0, 2, [9, 0], 1, 10)
  );

  it('should return 11-1 in base 10',
  ...
  it('should return 300000-1 in base 10',
    () => test([0,0,0,0,0,3], 0, 6, [9,9,9,9,9,2], 6, 10)
  );

  it('should return 321-1 in base 179',
    () => test([142, 1], 0, 2, [141, 1], 2, 179)
  );

  it('should return 28,676,695-1 in base 179',
    () => test([0,0,0,5], 0, 4, [178,178,178,4], 4, 179)
  );

  it('should return 72-1 in base 2',
