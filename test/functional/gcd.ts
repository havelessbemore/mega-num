...
describe('gcd', () => {
  ...
  it('should return should return gcd(A,A) = A in base 10', () => {
  ...
  it('should return should return gcd(A,0) = A in base 10', () => {
    const A: Integer = toInteger([3,2,1], 1, false, 10);
  ...
  it('should return should return gcd(0,B) = B in base 10', () => {
  ...
  it('should return should return gcd(1,1) = 1 in base 10', () => {
  ...
  it('should return should return gcd(18,84) = 6 in base 10', () => {
  ...
  it('should return should return gcd(-48,18) = 6 in base 10', () => {
