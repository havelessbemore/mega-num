...
describe('subtract', function(){
  ...
  it('should set A to zero if A === B', function(){
  ...
  it('should set A to -B if A = 0', function(){
    const A: Integer = toInteger([], 0, false, 10);
  ...
  it('should add if signs of A and B differ', function(){
  ...
  it('should use negate() and add() correctly if signs of A and B differ', function(){
    const A: Integer = toInteger([3], 1, false, 10);
