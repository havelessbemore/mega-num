...
describe('multiply', () => {
  ...
  it('should return A*A in base 10', () => {
  ...
  it('should return 123*0 in base 10', () => {
  ...
  it('should return 2 * 123 in base 10', () => {
    const A: Integer = toInteger([2], 1, false, 10);
    const B: Integer = toInteger([3,2,1], 3, false, 10);
    const expected: Integer = toInteger([6,4,2], 3, false, 10);
  ...
  it('should return 3 * 123 in base 10', () => {
  ...
  it('should return [100 digit number] ^ [100 digit number] in base 10', () => {
